        ...
        @if (Browser::isMobile())
            <div class="col-6 col-sm-6 col-md-4 col-xs-12 p-1">
                <div class="card mb-1 shadow border-warning service-item">
                    <img class="card-img-top border-bottom" src="{{ cdn_asset('/dist/all/img/package/' . \Illuminate\Support\Str::slug($value['name']).'.png'  ?? null) }}"
                         alt="{{ $value['name'] }}">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body text-center p-3">
                                ...
                                <span class="badge bg-success fs-5 mb-3">
                                    {{ $value['quota'] }} {{ __('site.label.folder') }}
                                </span>
