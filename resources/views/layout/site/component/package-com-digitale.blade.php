            ...
            <div class="card-body text-center bg-f0f0f0 px-2 py-1">
                <span class="card-title pricing-card-title fs-6 fw-bold">
                    <span class="text-dark">
                        {{ Helpy::formatPrice($value['price'], json_decode(Cookie::get('preference'))->currency == 'xof'
                        ? false : true) }}
                    </span>
                </span>
                <div class="mt-1">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body text-center p-3">
                        <ul class="list-unstyled text-secondary mb-0">
                            @foreach (collect($value)->except(['name', 'uuid', 'price', 'currency', 'price_unit',
                            'price_duration',
                            'detail', 'photo']) as $key => $item)
                            <li class="text-start">
                                <b>{{ __('site.label.' . $key) }}</b>
