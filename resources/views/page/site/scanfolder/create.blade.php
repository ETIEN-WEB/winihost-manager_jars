        ...
        <div class="card border shadow mb-3">
            <div class="card-header bg-secondary text-white">
                <h5 class="card-title text-white my-2 d-inline">
                    {{ __('site.wording.add_new_scanfolder') }}
                </h5>
            </div>
            <div class="card-body">
                ...
                <form method="POST" class="row">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <input type="number" min="0" id="port" name="port" value="{{ old('port') }}"
                            class="form-control mb-2" placeholder="{{ __('site.input.placeholder.port') }}" required>
                    </div>
                    <div class="form-group col-md-12">
                        <label class="fw-bold" for="root">Ftp : {{ __('site.label.path') }}</label>
                        <input type="text" id="root" name="root" value="{{ old('root') }}" class="form-control mb-2"
                            placeholder="{{ __('site.input.placeholder.path') }}" required>
                    </div>
                    <div class="form-group col-md-12">
                        <label class="fw-bold" for="excepts">{{ __('site.label.except') }}</label>
                        <input type="text" id="excepts" name="excepts" value="{{ old('excepts') }}"
