        ...
        <div class="card border shadow mb-3">
            <div class="card-header bg-secondary text-white">
                <h5 class="card-title text-white my-2 d-inline">
                    {{ __('site.wording.edit_dns_record') }}
                </h5>
            </div>
            <div class="card-body">
                ...
                <form method="POST" class="row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select name="type" id="selectType" class="form-control mb-2" required>
                            ...
                            <option {{ $record_detail['type'] == $value['type'] ? 'selected' : null }}
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select name="proxied" id="proxied" class="form-control mb-2" required>
                            <option {{ $record_detail['proxied'] == true ? 'selected' : null }} value="true">
                                Activer
                            </option>
                            <option {{ $record_detail['proxied'] == false ? 'selected' : null }} value="false">
                                Désactiver
                            </option>
                        </select>
                    </div>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" id="priority" name="priority"
                            value="{{ old('priority') ?? $record_detail['priority'] }}" class="form-control mb-2"
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <input type="text" name="name" class="form-control mb-2"
                            value="{{ old('name') ?? $record_detail['name'] }}" placeholder="Ex : mydomain.com"
                            required>
                    </div>
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <textarea name="content" rows="8" class="form-control mb-3" placeholder="Ex : 192.168.1.1"
                            required>{{ old('content') ?? $record_detail['content'] }}</textarea>
                    </div>
